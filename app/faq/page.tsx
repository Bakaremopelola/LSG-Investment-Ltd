  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="w-full bg-white text-center ">
        <Image className="w-[100vw] h-[25vh] lg:h-auto" src={ex} alt="" />
      </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-[#1D2150] text-white py-3 rounded-lg hover:bg-[#13163A] transition-colors"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="hidden md:block">
            <Image src={ey} alt="Contact Us" className="w-full h-auto" />
          </div>
        </div>
      </section>

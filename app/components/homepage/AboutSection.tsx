import { CgCommunity, CgUser } from "react-icons/cg";
import houseimg from "../../../assets/Frame8.png"; 
      ...
      <div className="flex flex-col md:flex-row px-16 md:gap-0 items-center gap-4 m-0 justify-center">
        ...
        <div className=" lg:h-[550px] lg:w-[20vw] rounded-lg overflow-hidden">
          <Image
            src={houseimg}
            alt="House"
            className="w-full h-full object-cover hidden lg:flex rounded-lg"
          />
        </div>


        <div className="bg-[#1D2150] text-white px-4 md:px-10 w-[80vw] py-12 lg:px-10 md:w-[35vw] lg:w-[25vw] md:h-[650px] shadow-lg">
        ...
        {/* Why Choose Us */}
        <div className="px-6 md:px-10 w-[80vw] py-12 lg:px-10 md:w-[40vw] lg:w-[30vw] md:h-[650px] shadow-lg ">

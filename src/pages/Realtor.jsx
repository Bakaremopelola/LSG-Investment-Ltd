      ...
      <div className="container mx-auto p-4 flex flex-col md:flex-row bg-white shadow-lg rounded-lg my-10">
        ...
        <div className="w-full md:w-2/3 p-8">
          ...
          <form className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input type="text" placeholder="Realtor License number*" className="p-3 border rounded-md w-full" />
              <input type="text" placeholder="Agency name*" className="p-3 border rounded-md w-full" />
            </div>

            <input type="text" placeholder="Years of experience*" className="p-3 border rounded-md w-full" />

            <textarea placeholder="Areas of specialization*" className="p-3 border rounded-md w-full h-24"></textarea>

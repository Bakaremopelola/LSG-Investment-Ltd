...
const Banners = () => {
  ...
  return (
    <section className="w-full lg:w-[80vw] md:w-3xl mx-auto h-[40vh] lg:h-[30vh] flex items-center justify-center px-6 md:px-16 py-6">
      <div className="bg-[#47B649] lg:bg-[#1D2150] text-white rounded-2xl w-full px-6 md:px-8 py-6 flex flex-col lg:flex-row items-center jusify-center lg:justify-between shadow-lg">
        {/* Left Content */}

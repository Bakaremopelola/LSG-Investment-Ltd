  ...
  return (
    <div className="bg-gradient-to-r from-yellow-500 to-green-500 px-6 lg:px-40 py-6 flex flex-col md:flex-row justify-between items-center text-white rounded-lg shadow-lg">
      ...
      <div className="text-center md:text-left mb-4 md:mb-0">
        <h2 className="text-3xl lg:text-lg font-bold">Ready to Buy, Sell, or Invest?</h2>
        <p className=" text-xl text-blue-950 lg:text-white lg:text-sm max-w-md">
      ...
      {/* Buttons */}
      <div className="flex space-x-4 flex-col md:flex-rows gap-4">
        <button onClick={handleClick} className="bg-blue-900 text-white px-5 py-2 rounded-4xl text-xl font-medium hover:bg-blue-700 w-[80vw] h-[4em] transition">
          Get a FREE Quote
        </button>

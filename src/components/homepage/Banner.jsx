...
const Banner = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-yellow-500 to-green-500 px-6 lg:px-40 py-6 flex flex-col md:flex-row  md:justify-between items-center text-white rounded-lg shadow-lg">
      {/* Text Section */}
